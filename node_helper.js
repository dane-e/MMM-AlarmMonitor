...
module.exports = NodeHelper.create({
	...
	start: function() {
		this.expressApp.get('/AlarmMonitor', (req, res) => {
			...
			if (message == null && type == null){
				...
				if(data == null){
					...
					var params = {"type": type, "message": message, "timestamp": new Date(), "data": data};
					this.sendSocketNotification("NEW_MESSAGE", params);
				}
				this.storeLog(log);
			}
		});
